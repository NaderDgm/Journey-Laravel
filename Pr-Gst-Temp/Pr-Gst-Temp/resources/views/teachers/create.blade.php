...
@section('content')
    <div class="mx-auto max-w-3xl">
        <h1 class="text-2xl font-semibold text-slate-900">Ajouter un professeur</h1>
        <p class="mt-1 text-sm text-slate-600">Ajoutez un professeur à la liste.</p>

        <form action="{{ route('teachers.store') }}" method="POST" class="mt-6 space-y-6 rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            @csrf
